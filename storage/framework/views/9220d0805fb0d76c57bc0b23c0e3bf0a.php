...
<head>
    ...
    <title><?php echo $__sections["title"] ?? "Nexus Framework"; ?></title>
...
<body class="font-sans bg-gradient-to-br from-white via-primary-500 to-secondary-500 min-h-screen">
    ...
    <footer class="text-center py-12 text-white/90">
        <p class="text-lg">&copy; <?php echo e(date('Y')); ?> Nexus Framework. Open Source under MIT License.</p>
        <p class="mt-2">
