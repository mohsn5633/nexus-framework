<?php $__extends = "layouts.app"; ?>

<?php $__currentSection = "title', 'Nexus Framework - A Modern PHP Framework"; ob_start(); ?>
...
<?php $__currentSection = "content"; ob_start(); ?>
    ...
    <div class="text-center px-8 py-16 bg-white rounded-3xl shadow-2xl mb-12">
        ...
        <div class="flex gap-4 justify-center flex-wrap mt-8">
            ...
            <a href="https://github.com/nexus-framework/nexus" target="_blank" class="inline-flex items-center gap-2 px-8 py-4 bg-white text-gray-800 border-2 border-primary-500 rounded-xl font-semibold text-base transition-all hover:-translate-y-1 hover:bg-gray-50">
...
<code class="text-sm leading-relaxed">git clone https://github.com/nexus-framework/nexus.git
cd nexus
...
use Nexus\Http\<?php echo e('{'); ?>Request, Response, Get, Post<?php echo e('}'); ?>;
...
class UserController
{
    ...
    <div id="documentation" class="bg-white p-12 rounded-3xl shadow-lg mb-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
            <a href="https://github.com/nexus-framework/nexus/wiki/Getting-Started" class="block p-6 bg-gray-50 rounded-xl border-2 border-transparent hover:bg-white hover:border-primary-500 hover:-translate-y-1 transition-all" target="_blank">
            ...
            <a href="https://github.com/nexus-framework/nexus/wiki/Routing" class="block p-6 bg-gray-50 rounded-xl border-2 border-transparent hover:bg-white hover:border-primary-500 hover:-translate-y-1 transition-all" target="_blank">
            ...
            <a href="https://github.com/nexus-framework/nexus/wiki/Database" class="block p-6 bg-gray-50 rounded-xl border-2 border-transparent hover:bg-white hover:border-primary-500 hover:-translate-y-1 transition-all" target="_blank">
            ...
            <a href="https://github.com/nexus-framework/nexus/wiki/Views" class="block p-6 bg-gray-50 rounded-xl border-2 border-transparent hover:bg-white hover:border-primary-500 hover:-translate-y-1 transition-all" target="_blank">
            ...
            <a href="https://github.com/nexus-framework/nexus/wiki/Validation" class="block p-6 bg-gray-50 rounded-xl border-2 border-transparent hover:bg-white hover:border-primary-500 hover:-translate-y-1 transition-all" target="_blank">
            ...
            <a href="https://github.com/nexus-framework/nexus/wiki/CLI" class="block p-6 bg-gray-50 rounded-xl border-2 border-transparent hover:bg-white hover:border-primary-500 hover:-translate-y-1 transition-all" target="_blank">
    ...
    <div class="bg-white p-12 rounded-3xl shadow-lg mb-12">
        ...
        <div class="text-center">
            <a href="https://github.com/nexus-framework/nexus" target="_blank" class="inline-flex items-center gap-3 px-10 py-5 bg-gradient-to-r from-primary-500 to-secondary-500 text-white rounded-xl font-bold text-lg transition-all hover:-translate-y-1 hover:shadow-2xl shadow-lg">
            ...
            <p class="mt-4 text-gray-600">
                Join <strong class="text-gray-800"><?php echo e($stats['stars'] ?? '1,000+'); ?></strong> developers using Nexus Framework
            </p>
        </div>
    </div>
<?php $__sections[$__currentSection] = ob_get_clean(); ?>
